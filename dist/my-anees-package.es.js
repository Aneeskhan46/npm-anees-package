...
function Y(r) {
  ...
  let a = l.querySelector(`[${it}]`);
  a && a.getAttribute("data-cache") === n || (a || (a = document.createElement("style"), a.setAttribute(it, "true"), l.appendChild(a)), a.setAttribute("data-cache", n), a.textContent = `
    ${h ? `
...
const Gt = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "—", insert: "—", title: "Em dash" },
      {
        ...
        moreItems: [
          // Right-left arrow
          { label: "↔̅", insert: "\\overset{#?}{\\leftrightarrow}", isWidget: !0, title: "Left-right arrow with overscript" },
          { label: "↔̲", insert: "\\underset{#?}{\\leftrightarrow}", isWidget: !0, title: "Left-right arrow with underscript" },
          { label: "↔̲̅", insert: "\\overset{#?}{\\underset{#?}{\\leftrightarrow}}", isWidget: !0, title: "Left-right arrow with under & overscript" },
          { label: "⇆̅", insert: "\\overset{#?}{\\leftrightarrows}", isWidget: !0, title: "Short rightwards arrow over leftwards arrow with overscript" },
          // Left arrow over right arrow
          { label: "⇆̲", insert: "\\underset{#?}{\\leftrightarrows}", isWidget: !0, title: "Left arrow over right arrow with underscript" },
          { label: "⇆̲̅", insert: "\\overset{#?}{\\underset{#?}{\\leftrightarrows}}", isWidget: !0, title: "Left arrow over right arrow with under & overscript" },
          // Right arrow over left arrow
          { label: "⇄̅", insert: "\\overset{#?}{\\rightleftarrows}", isWidget: !0, title: "Right arrow over left arrow with overscript" },
          { label: "⇄̲", insert: "\\underset{#?}{\\rightleftarrows}", isWidget: !0, title: "Right arrow over left arrow with underscript" },
          { label: "⇄̲̅", insert: "\\overset{#?}{\\underset{#?}{\\rightleftarrows}}", isWidget: !0, title: "Right arrow over left arrow with under & overscript" },
          // Left harpoon over right harpoon
          { label: "⇋̅", insert: "\\overset{#?}{\\leftrightharpoons}", isWidget: !0, title: "Left harpoon over right harpoon with overscript" },
          { label: "⇋̲", insert: "\\underset{#?}{\\leftrightharpoons}", isWidget: !0, title: "Left harpoon over right harpoon with underscript" },
          { label: "⇋̲̅", insert: "\\overset{#?}{\\underset{#?}{\\leftrightharpoons}}", isWidget: !0, title: "Left harpoon over right harpoon with under & overscript" },
          // Right harpoon over left harpoon
          { label: "⇌̅", insert: "\\overset{#?}{\\rightleftharpoons}", isWidget: !0, title: "Right harpoon over left harpoon with overscript" },
          { label: "⇌̲", insert: "\\underset{#?}{\\rightleftharpoons}", isWidget: !0, title: "Right harpoon over left harpoon with underscript" },
          { label: "⇌̲̅", insert: "\\overset{#?}{\\underset{#?}{\\rightleftharpoons}}", isWidget: !0, title: "Right harpoon over left harpoon with under & overscript" },
          // Rightwards arrow over short leftwards arrow
          { label: "⇄̅", insert: "\\overset{#?}{\\underset{\\leftarrow}{\\rightarrow}}", isWidget: !0, title: "Rightwards arrow over short leftwards arrow with overscript" },
          { label: "⇄̲", insert: "\\underset{#?}{\\underset{\\leftarrow}{\\rightarrow}}", isWidget: !0, title: "Rightwards arrow over short leftwards arrow with underscript" },
          { label: "⇄̲̅", insert: "\\overset{#?}{\\underset{#?}{\\underset{\\leftarrow}{\\rightarrow}}}", isWidget: !0, title: "Rightwards arrow over short leftwards arrow with under & overscript" },
          // Short rightwards arrow over leftwards arrow
          { label: "⇆̅", insert: "\\overset{#?}{\\overset{\\rightarrow}{\\leftarrow}}", isWidget: !0, title: "Short rightwards arrow over leftwards arrow with overscript" },
          { label: "⇆̲", insert: "\\underset{#?}{\\overset{\\rightarrow}{\\leftarrow}}", isWidget: !0, title: "Short rightwards arrow over leftwards arrow with underscript" },
          { label: "⇆̲̅", insert: "\\overset{#?}{\\underset{#?}{\\overset{\\rightarrow}{\\leftarrow}}}", isWidget: !0, title: "Short rightwards arrow over leftwards arrow with under & overscript" }
        ]
      },
      ...
      { label: "⇀", insert: "\\overrightharpoon{#?}", title: "Left harpoon accent" },
      // Left harpoon accent
      { label: "↔", insert: "\\overleftrightarrow{#?}", title: "Left-right arrow accent" },
      // Left-right arrow accent
      { label: "→", insert: "\\overrightarrow{#?}", title: "Right arrow accent" },
      // Arrow accent (right arrow)
  ...
  },
  {
    ...
    items: [
      ...
      { label: "(□ \\ □)", insert: "\\begin{pmatrix} #? \\\\ #? \\end{pmatrix}", cls: "template", directInsert: !0, title: "Begin pmatrix" },
      { label: "□ □ □", insert: "\\begin{matrix} #? \\,  #? \\,  #? \\end{matrix}", cls: "template", directInsert: !0, title: "Begin matrix" },
      { label: "[□ & □]", insert: "\\begin{bmatrix} #? \\, #? \\end{bmatrix}", cls: "template", directInsert: !0, title: "Begin bmatrix" },
      { label: "(□ & □)", insert: "\\begin{pmatrix} #? \\, #? \\end{pmatrix}", cls: "template", directInsert: !0, title: "Begin pmatrix" },
      { type: "sep", cols: 2, cls: "cme-matrix-subgroup" },
      // Two rows column with left curly brackets
      { label: "{", insert: "\\begin{cases} #? \\\\ #? \\end{cases}", cls: "template", directInsert: !0, title: "Begin cases" },
      // Piecewise function
      { label: "f(x)", insert: "\\begin{cases} #?, \\, #? \\\\ #?, \\, #? \\end{cases}", cls: "template", directInsert: !0, title: "Begin cases" },
      // Two rows column with right curly brackets
      { label: "}", insert: "\\left.\\begin{matrix} #? \\\\ #? \\end{matrix}\\right\\}", cls: "template", directInsert: !0, title: "Begin matrix" },
      // Aligned equations
      { label: "=", insert: "\\begin{aligned} #? &= #? \\\\ #? &= #? \\end{aligned}", cls: "template", directInsert: !0, title: "Begin aligned" },
      ...
      { label: "⋱", insert: "\\ddots", title: "Down-right diagonal ellipses" },
      {
        ...
        moreItems: [
          // sub addition
          { label: " ", insert: "\\frac{\\begin{array}{r}#?\\\\ \\,#?\\end{array}}{\\;#?}", isWidget: !0, directInsert: !0, title: "Begin array", cls: "cme-matrix-subgroup" },
          { label: "-", insert: "\\frac{\\begin{array}{r}#?\\\\-\\,#?\\end{array}}{\\quad#?}", isWidget: !0, directInsert: !0, title: "Begin array", cls: "cme-matrix-subgroup" },
          { label: "*", insert: "\\frac{\\begin{array}{r}#?\\\\*\\,#?\\end{array}}{\\quad#?}", isWidget: !0, directInsert: !0, title: "Begin array", cls: "cme-matrix-subgroup" },
          { label: "÷", insert: "\\begin{array}{r@{}l} #?\\, & \\begin{array}{|@{}l} \\underline{\\;#?\\;\\,} \\end{array} \\\\ & \\; #? \\end{array}", isWidget: !0, directInsert: !0, title: "Begin array", cls: "cme-matrix-subgroup" },
          { label: "÷", insert: "\\begin{array}{r@{}l} #?\\, & \\begin{array}{|@{}l} \\underline{\\;#?\\;\\,} \\end{array} \\\\ #?\\, & \\; #? \\end{array}", isWidget: !0, directInsert: !0, title: "Begin array", cls: "cme-matrix-subgroup" },
          // Long division
          { label: "⟌", insert: "#?\\, ) \\!\\!\\!\\!\\! \\begin{array}\\overset{\\displaystyle #?}{\\overline{\\vphantom{1}\\;\\;#?\\;}} \\\\ \\;\\;#?\\; \\end{array}", isWidget: !0, directInsert: !0, title: "Begin array", cls: "cme-matrix-subgroup" }
        ]
      },
      // Column addition
      { label: "+", insert: "\\frac{\\begin{array}{r}#?\\\\+\\,#?\\end{array}}{\\quad#?}", isWidget: !0, directInsert: !0, title: "Begin array" },
      // Long division
      { label: "⟌", insert: "#?\\, ) \\!\\! \\overset{\\displaystyle #?}{\\overline{\\vphantom{1}\\;\\;#?\\;}}", isWidget: !0, directInsert: !0, title: "Vphantom 1" }
    ]
  },
  {
    label: "□̅",
    ...
    items: [
      ...
      {
        label: /* @__PURE__ */ t.createElement("svg", { width: "20", height: "18", viewBox: "0 0 20 18", fill: "none", stroke: "currentColor", strokeWidth: "1.5", style: { display: "inline-block", verticalAlign: "middle", color: "#666", marginLeft: "13px" } }, /* @__PURE__ */ t.createElement("rect", { x: "2", y: "2", width: "6", height: "12", rx: "1" }), /* @__PURE__ */ t.createElement("rect", { x: "10", y: "2", width: "6", height: "12", rx: "1" })),
        insert: "\\,",
        cls: "template",
        directInsert: !0,
        action: "INSERT_CUSTOM",
      ...
      {
        label: /* @__PURE__ */ t.createElement("svg", { width: "16", height: "18", viewBox: "0 0 16 18", fill: "none", stroke: "currentColor", strokeWidth: "1.5", style: { display: "inline-block", verticalAlign: "middle", color: "#666" } }, /* @__PURE__ */ t.createElement("rect", { x: "2", y: "2", width: "6", height: "12", rx: "1" }), /* @__PURE__ */ t.createElement("rect", { x: "8", y: "2", width: "6", height: "12", rx: "1" })),
        insert: "\\!",
        cls: "template",
        directInsert: !0,
        action: "INSERT_CUSTOM",
    ...
    items: [
      {
        ...
        moreItems: [
          // Floor
          { label: "⌊ ⌋", insert: "\\lfloor #? \\rfloor", isWidget: !0, title: "Lfloor" },
          // Angle bracket with bar
          { label: "〈|", insert: "\\langle #? \\mid #? \\rangle", isWidget: !0, title: "Langle" },
          // Ceiling
          { label: "⌈ ⌉", insert: "\\lceil #? \\rceil", isWidget: !0, title: "Lceil" }
        ]
      },
      // Parentheses
      ...
      { type: "sep", cols: 2, small: !0, cls: "cme-matrix-subgroup" },
      // Overbrace
      { label: "⏞", insert: "\\overbrace{#?}", isWidget: !0, title: "Overbrace" },
      // Overgroup
      { label: "⎴", insert: "\\overgroup{#?}", isWidget: !0, title: "Overgroup" },
      // Overbrace
      { label: "⏟", insert: "\\underbrace{#?}", isWidget: !0, title: "Overbrace" },
      // Undergroup
      { label: "⎵", insert: "\\undergroup{#?}", isWidget: !0, title: "Undergroup" },
      { type: "sep", cols: 3, small: !0, cls: "cme-symbol-subgroup" },
      // Overrightharpoon
      { label: "⇀", insert: "\\overrightharpoon{#?}", isWidget: !0, title: "Right harpoon accent" },
      // Arrow accent
      ...
      { label: "¯", insert: "\\overline{#?}", title: "Bar accent" },
      // Wide hat
      { label: "^", insert: "\\widehat{\\mathrm{#?}}", isWidget: !0, title: "Wide hat" },
      // Tilde accent
      { label: "∼", insert: "\\tilde{#?}", isWidget: !0, title: "Tilde accent" },
      // Diaeresis accent
      { label: "¨", insert: "\\ddot{#?}", isWidget: !0, title: "Diaeresis accent" },
      // Dot accent
      { label: "˙", insert: "\\dot{#?}", isWidget: !0, title: "Dot accent" },
      {
        type: "sep",
        cols: 3,
        small: !0,
  ...
  },
  {
    ...
    items: [
      ...
      { label: "∑", insert: "\\sum\\nolimits_{#?}^{#?}", isWidget: !0, title: "Summation with side limits" },
  ...
  },
  {
    label: /* @__PURE__ */ t.createElement(
      ...
      /* @__PURE__ */ t.createElement("path", { d: "M32 12 L24 24 H40 Z", fill: "currentColor" }),
      /* @__PURE__ */ t.createElement("path", { d: "M16 36 C16 48, 48 48, 48 36" }),
      /* @__PURE__ */ t.createElement("path", { d: "M22 36 C22 43, 42 43, 42 36" })
    ),
    items: [
      { type: "sep", cols: 2, cls: "cme-trig-subgroup" }
    ]
...
], Yt = [
  {
    ...
    items: [
      ...
      { label: "⇌", insert: "\\overset{#?}{\\rightleftharpoons}", isWidget: !0, title: "Equilibrium with overscript" },
      { label: "⇌", insert: "\\underset{#?}{\\rightleftharpoons}", isWidget: !0, title: "Equilibrium with underscript" },
      { label: "⇄", insert: "\\rightleftarrows", isWidget: !0, title: "Right left arrows" },
      { label: "⇄", insert: "\\overset{#?}{\\rightleftarrows}", isWidget: !0, title: "Right left arrows with overscript" },
      { label: "⇄", insert: "\\underset{#?}{\\rightleftarrows}", isWidget: !0, title: "Right left arrows with underscript" },
      { type: "sep", cols: 2, small: !0, cls: "cme-matrix-subgroup" },
      // Superscript and subscript
      { label: "xⁿₖ", insert: "{#?}_{#?}^{#?}", isWidget: !0, title: "Subscript and superscript" },
      // Superscript
      { label: "xⁿ", insert: "{#?}^{#?}", isWidget: !0, title: "Superscript" },
      // Left subscript and superscript
      { label: "ⁿₖx", insert: "{}_{#?}^{#?}{#?}", isWidget: !0, title: "Left subscript and superscript" },
      // Subscript
      { label: "xₖ", insert: "{#?}_{#?}", isWidget: !0, title: "Subscript" },
      { type: "sep", cols: 1, small: !0 },
      // Parentheses
      { label: "", insert: "\\left( #? \\right)", title: "Parentheses", isWidget: !0 },
      // Square brackets
      { label: "[ ]", insert: "\\left[ #? \\right]", title: "Square brackets", isWidget: !0 },
      // Curly brackets
      { label: "{ }", insert: "\\left\\{ #? \\right\\}", title: "Curly brackets", isWidget: !0 },
      { type: "sep", cols: 1 },
      // 6. Undo / Redo (1 col)
      { label: "↶", action: "UNDO", title: "Undo" },
      { label: "↷", action: "REDO", title: "Redo" },
...
class _t extends ht {
  ...
  init() {
    const l = this.editor;
    l.model.schema.register("mathInline", {
      isInline: !0,
      isObject: !0,
      allowWhere: "$text",
      allowAttributes: ["latex"]
    }), l.model.schema.addChildCheck((n, a) => {
    ...
    this.listenTo(h, "mousedown", (n, a) => {
      ...
      model: "mathInline",
      view: (n, { writer: a }) => {
        const s = n.getAttribute("latex") || "", i = a.createContainerElement("span", {
          class: "math-tex",
          "data-latex": s,
          style: "display:inline;"
        });
        return a.insert(a.createPositionAt(i, 0), a.createText(s)), i;
      }
      ...
      model: (n, { writer: a }) => {
        const s = n.getAttribute("data-latex") || "";
        return a.createElement("mathInline", { latex: s });
      }
    });
  }
}
...
function le({ matrixType: r, x: l, y: h, onSelect: n, onMouseEnter: a, onMouseLeave: s }) {
  ...
  return q(() => {
    ...
    /* @__PURE__ */ t.createElement("div", { className: "cme-matrix-hover-footer" }, /* @__PURE__ */ t.createElement("div", { className: "cme-matrix-counter" }, /* @__PURE__ */ t.createElement("span", null, "R"), /* @__PURE__ */ t.createElement(
      "input",
      {
        type: "number",
        ...
        e.mathLabel ? /* @__PURE__ */ t.createElement(
          "math-field",
          {
            ...
            style: {
              ...
              border: "none",
              outline: "none",
              fontSize: e.fontSize || (e.isMatrix ? "8px" : "11px"),
              display: "inline-block",
              width: "auto",
              minHeight: "auto",
              padding: "0",
    ...
    u && G(/* @__PURE__ */ t.createElement(
      ...
      u.items.map((e, m) => /* @__PURE__ */ t.createElement(
        "button",
        {
          ...
          onMouseDown: (b) => {
            b.preventDefault(), Q(e.insert), A(null);
          }
        },
        e.insert && !e.action && (e.cls === "template" || e.isWidget) ? /* @__PURE__ */ t.createElement(
          "math-field",
          {
            "read-only": !0,
            style: {
...
function de({ value: r, onChange: l }) {
  ...
  const c = J((v) => {
    ...
    if (!(!x || !(v != null && v.trim()))) {
      if (i) {
        ...
        x.model.change((B) => {
          const C = B.createElement("mathInline", { latex: v.trim() });
          x.model.insertContent(C), x.model.insertContent(B.createText(" "));
        });
  ...
  return /* @__PURE__ */ t.createElement("div", { style: { position: "relative", display: "flex", flexDirection: "column", gap: "8px" } }, /* @__PURE__ */ t.createElement("style", null, `
      ...
      `), /* @__PURE__ */ t.createElement("div", { style: { display: "flex", alignItems: "center", gap: "8px", padding: "2px 4px" } }, /* @__PURE__ */ t.createElement("label", { style: { display: "inline-flex", flexDirection: "row", alignItems: "center", gap: "8px", cursor: "pointer", userSelect: "none", width: "auto", fontSize: "13px", color: "var(--text)", fontWeight: 600 } }, /* @__PURE__ */ t.createElement(
    "input",
    {
      type: "checkbox",
      checked: f,
  ...
  ), /* @__PURE__ */ t.createElement("span", null, "Insert as editable Unicode text (allows character-by-character deletion)"))), /* @__PURE__ */ t.createElement("div", { style: { marginTop: "10px", marginBottom: "10px" } }, /* @__PURE__ */ t.createElement(
    "button",
    {
      type: "button",
      onClick: () => A(!0),
  ...
  } }, /* @__PURE__ */ t.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #ccc", paddingBottom: "10px", marginBottom: "20px" } }, /* @__PURE__ */ t.createElement("h3", { style: { margin: 0 } }, "Question Preview"), /* @__PURE__ */ t.createElement(
    "button",
    {
      onClick: () => A(!1),
    ...
    re,
    {
      ...
      onInsert: T,
      onClose: E,
      initialLatex: (i == null ? void 0 : i.latex) || "",
      isEditing: !!i
    }
  ));
}
