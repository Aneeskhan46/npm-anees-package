...
function G(t) {
  const l = t == null ? void 0 : t.shadowRoot;
  if (!l) return;
  const i = t.hasAttribute("read-only") || t.hasAttribute("readonly"), a = i ? "readonly" : "editable";
  let n = l.querySelector(`[${se}]`);
  n && n.getAttribute("data-cache") === a || (n || (n = document.createElement("style"), n.setAttribute(se, "true"), l.appendChild(n)), n.setAttribute("data-cache", a), n.textContent = `
    ${i ? `
...
let $ = null;
function Je() {
  $ || (Ze(), $ = new MutationObserver((t) => {
    var l, i, a;
    for (const n of t) {
      if (n.type === "attributes" && ((l = n.target.tagName) == null ? void 0 : l.toLowerCase()) === "math-field") {
        G(n.target);
        continue;
      }
      if (n.addedNodes)
        for (const s of n.addedNodes)
          s instanceof Element && (((i = s.tagName) == null ? void 0 : i.toLowerCase()) === "math-field" && requestAnimationFrame(() => G(s)), (a = s.querySelectorAll) == null || a.call(s, "math-field").forEach((o) => requestAnimationFrame(() => G(o))));
    }
...
function he(t) {
  ...
  const a = () => {
    ...
    try {
      window.__cme_macros && (i.macros = { ...i.macros, ...window.__cme_macros }), i.setValue ? i.setValue(l) : i.value = l;
    } catch (n) {
...
function me(t, l) {
  ...
  const a = /* @__PURE__ */ new Set([
    ...
    Array.from(o.childNodes).forEach((m) => {
      if (m.nodeType === Node.TEXT_NODE)
        ...
        const A = m.nodeName;
        if (A === "MATH-FIELD") {
          const u = m.getAttribute("value") || m.value || m.textContent || "", v = ue(u);
          if (!v || v.trim() === "")
          ...
          u.className = "math-tex", m.getAttribute("data-latex") && u.setAttribute("data-latex", m.getAttribute("data-latex")), u.textContent = m.textContent, c.appendChild(u);
        } else if (a.has(A)) {
          const u = { STRONG: "b", EM: "i" }, v = document.createElement(u[A] || A.toLowerCase());
  ...
  for (n(i, s); s.firstChild; ) t.appendChild(s.firstChild);
}
function ze({ value: t = "" }) {
  const l = F(null);
  return R(() => {
    ...
    for (; (s = a.exec(t)) !== null; ) {
      if (s.index > n) {
        const c = t.slice(n, s.index);
        me(i, c);
      }
      const o = s[1];
      i.appendChild(he(o)), n = s.index + s[0].length;
    }
    n < t.length && me(i, t.slice(n)), i.querySelectorAll("span.math-tex").forEach((o) => {
      const c = o.getAttribute("data-latex") || o.textContent || "", m = he(c);
      o.replaceWith(m);
    });
...
function Ge({ isOpen: t, onClose: l, onInsert: i, position: a }) {
  ...
  const m = te(() => {
    ...
    if (o !== "All" && (b = b.filter((x) => x.category === o)), n.trim()) {
      ...
      b = b.filter((k) => k.code.includes(x));
    }
    return b;
  }, [o, n]), A = te(() => {
    if (o !== "All" && !n.trim())
  ...
  if (R(() => (t && window.addEventListener("keydown", u), () => window.removeEventListener("keydown", u)), [t]), !t) return null;
...
function xe(t) {
  var i, a, n, s, o;
  if (!t) return null;
  const l = typeof t.composedPath == "function" ? t.composedPath() : [t];
  for (const c of l)
...
function Q(t) {
  if (!t) return "";
  const l = t.getAttribute("data-latex");
  if (l) return l;
...
function ie(t, l) {
  if (!t || !l) return !1;
  try {
    return t.model.createPositionBefore(l), !0;
  } catch {
    return !1;
  }
}
function _e(t, l) {
  ...
  const n = t.editing.view.domConverter.mapDomToView(l);
  if (n) {
...
function ne(t, l, i, a) {
  ...
  const n = ie(t, l) ? l : _e(t, a), s = (n == null ? void 0 : n.getAttribute("latex")) || i || Q(a);
  if (!s) return;
  n && t.model.change((c) => {
    c.setSelection(n, "on");
  });
...
function $e(t, l) {
  ...
  const i = (a) => {
    var n;
    a.button === 0 && (a.preventDefault(), a.stopPropagation(), (n = a.stopImmediatePropagation) == null || n.call(a), ne(t, null, Q(l), l));
  };
  l.addEventListener("mousedown", i, !0), l.addEventListener("click", i, !0);
}
const et = [
  {
    label: "√(□)",
...
class rt extends be {
  ...
  init() {
    ...
    }), l.model.schema.addChildCheck((a, n) => {
      ...
      view: (a, { writer: n }) => {
        ...
        const c = n.createContainerElement("span", {
          ...
          (A) => {
            ...
            customElements.get("math-field") ? requestAnimationFrame(v) : customElements.whenDefined("math-field").then(() => requestAnimationFrame(v)), A.appendChild(u);
            const b = () => {
        ...
        return n.insert(n.createPositionAt(c, 0), m), Fe(c, n, { label: "math formula" });
      }
    });
    const i = l.editing.view.document;
    this.listenTo(i, "mousedown", (a, n) => {
      const s = xe(n.domTarget);
      s && n.domEvent.button === 0 && (a.stop(), n.preventDefault(), ne(
        l,
        null,
        Q(s),
        s
...
const it = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path d="M4 12h3l3 6l5-12h5" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>', nt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><rect x="3" y="3" width="18" height="18" rx="3" fill="none" stroke="currentColor" stroke-width="2"/><text x="12" y="16" text-anchor="middle" font-size="12" font-weight="bold" fill="currentColor" font-family="system-ui, sans-serif">C</text><text x="6" y="8" font-size="4" font-weight="bold" fill="currentColor" font-family="system-ui, sans-serif">6</text></svg>';
function at(t) {
  return class extends be {
    init() {
      ...
      i.ui.componentFactory.add("mathType", () => {
        const a = new oe();
        return a.set({ label: "Math", icon: it, tooltip: "Insert Math Formula" }), a.on("execute", () => t("math")), a;
      }), i.ui.componentFactory.add("chemType", () => {
        const a = new oe();
        return a.set({ label: "Chemistry", icon: nt, tooltip: "Insert Chemistry Formula" }), a.on("execute", () => t("chem")), a;
      });
    }
  };
}
...
function st({ mode: t, onInsert: l, onClose: i, initialLatex: a, isEditing: n }) {
  ...
  R(() => {
    if (!m && !b) return;
    const r = (h) => {
      !h.target.closest(".cme-matrix-hover-popover") && !h.target.closest(".cme-matrix-btn-wrapper") && A(null), !h.target.closest(".cme-color-picker-popup") && !h.target.closest('[title="Text Color"]') && x(null);
    };
    ...
    return r.addEventListener("selection-change", h), r.addEventListener("input", h), r.addEventListener("keydown", h), setTimeout(H, 50), () => {
      r.removeEventListener("selection-change", h), r.removeEventListener("input", h), r.removeEventListener("keydown", h);
    };
  }, [H]);
  const Z = q((r) => {
    const h = s.current;
    ...
    const r = s.current;
    if (!r) return;
    let h = r.getValue ? r.getValue() : r.value;
    if (!h || h.trim() === "") {
      i();
      return;
    }
    t === "chem" && (h = lt(h)), l(h), r.setValue ? r.setValue("") : r.value = "", i();
  };
  return /* @__PURE__ */ e.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ e.createElement("div", { className: "cme-toolbar", role: "toolbar", "aria-label": "Symbol palette" }, /* @__PURE__ */ e.createElement("div", { className: "cme-toolbar-groups" }, M.map((r, h) => {
        ...
        r.mathLabel ? /* @__PURE__ */ e.createElement(
          "math-field",
          {
            ...
            style: {
              ...
              border: "none",
              outline: "none",
              fontSize: r.fontSize || (r.isMatrix ? "8px" : "11px"),
              display: "inline-block",
              width: "auto",
              minHeight: "auto",
              padding: "0",
      ...
      return p.map((E, f) => /* @__PURE__ */ e.createElement(
        ...
        {
          key: f,
          className: `cme-symbol-subgroup${E.small ? " cme-symbol-subgroup--small" : ""}${E.cls ? ` ${E.cls}` : ""}${E.moreItems ? " cme-subgroup-has-more" : ""}`,
          style: { gridTemplateColumns: `repeat(${E.cols}, auto)`, position: "relative" }
        },
        E.moreItems && /* @__PURE__ */ e.createElement(
          "button",
          {
            type: "button",
        ...
        E.items.map((g, V) => {
          ...
          if (g.type === "dropdown") {
            ...
            return /* @__PURE__ */ e.createElement(
              ...
              {
                key: V,
                className: `cme-btn template${z || X ? " active" : ""}`,
                value: N,
                style: {
                  width: g.width || "60px",
                  height: "18px",
                  ...
                  padding: "0",
                  margin: "2px 0",
                  gridColumn: E.cols === 3 || E.cols === 1 ? "span 1" : "span 2"
                },
                onChange: (J) => {
                  const _ = J.target.value, j = s.current;
                  !j || typeof j.applyStyle != "function" || (j.focus(), O ? j.applyStyle({ fontFamily: _ || "none" }) : W && j.applyStyle({ fontSize: _ ? parseInt(_, 10) : "auto" }), H());
                }
              },
              /* @__PURE__ */ e.createElement("option", { value: "" }, g.label),
              O && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement("option", { value: "roman" }, "Times"), /* @__PURE__ */ e.createElement("option", { value: "sans-serif" }, "Helvetica"), /* @__PURE__ */ e.createElement("option", { value: "monospace" }, "Courier")),
          ...
          if (P.isMatrix && !g.directInsert)
            return /* @__PURE__ */ e.createElement(
              ...
              /* @__PURE__ */ e.createElement(
                ...
                {
                  type: "button",
                  className: `cme-btn template${g.cls ? ` ${g.cls}` : ""}${P.isMatrix ? " cme-matrix-btn-small" : ""}`,
                  title: g.title || g.label || g.insert,
                  onMouseDown: (O) => {
                    if (O.preventDefault(), O.stopPropagation(), (m == null ? void 0 : m.type) === g.insert)
                      A(null);
                    else {
                ...
                typeof g.label == "object" ? g.label : /* @__PURE__ */ e.createElement(
                  "math-field",
                  {
                    "read-only": !0,
                    style: {
                  ...
                  ee(g.mathLabel != null ? g.mathLabel : g.insert)
                )
              )
            );
          ...
          return /* @__PURE__ */ e.createElement(
            "button",
            {
              key: `${P.label}-${f * 4 + V}`,
              type: "button",
              className: `cme-btn${P.isTemplate ? " template" : ""}${g.cls ? ` ${g.cls}` : ""}${Ae ? " active" : ""}`,
              title: g.title || g.label || g.insert,
              onMouseDown: (O) => {
                var z, X;
                O.preventDefault();
                ...
                } else g.action === "UNDO" ? (z = s.current) == null || z.executeCommand("undo") : g.action === "REDO" ? (X = s.current) == null || X.executeCommand("redo") : Z(g.insert);
              }
            },
            (P.isTemplate || P.label === "√(□)" || P.isMatrix || g.isWidget) && g.insert && !g.action && !g.forceLabel ? /* @__PURE__ */ e.createElement(
              "math-field",
              {
                "read-only": !0,
                style: {
    ...
    k && K(/* @__PURE__ */ e.createElement(
      "div",
      {
        ...
        style: {
          ...
          visibility: "hidden",
          zIndex: 1e5,
          gridTemplateColumns: `repeat(${k.cols || 1}, auto)`
        }
      },
      k.items.map((r, h) => /* @__PURE__ */ e.createElement(
        "button",
        {
          key: h,
          type: "button",
        ...
        r.insert && !r.action && (r.cls === "template" || r.isWidget) ? /* @__PURE__ */ e.createElement(
          ...
          ee(r.mathLabel != null ? r.mathLabel : r.insert)
        ) : r.label
      ))
    ), document.body),
    /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("div", { className: "cme-popup-footer" }, /* @__PURE__ */ e.createElement("button", { type: "button", className: "cme-insert-btn", onClick: Ee }, n ? "Update" : "Insert"), /* @__PURE__ */ e.createElement("button", { type: "button", className: "cme-cancel-btn", onClick: i }, "Cancel")),
    m && K(
      /* @__PURE__ */ e.createElement(
        ot,
        {
...
function ct(t) {
  ...
  ), l = l.replace(/\^([a-zA-Z0-9])/g, (o, c) => n[c] || c);
  const s = { 0: "₀", 1: "₁", 2: "₂", 3: "₃", 4: "₄", 5: "₅", 6: "₆", 7: "₇", 8: "₈", 9: "₉", "+": "₊", "-": "₋", "=": "₌", "(": "₍", ")": "₎", a: "ₐ", e: "ₑ", o: "ₒ", x: "ₓ", i: "ᵢ", j: "ⱼ", n: "ₙ" };
  return l = l.replace(
    /_\{([^}]*)\}/g,
    (o, c) => c.split("").map((m) => s[m] || m).join("")
  ), l = l.replace(/_([a-zA-Z0-9])/g, (o, c) => s[c] || c), l = l.replace(/->/g, "→"), l = l.replace(/<=>/g, "⇌"), l = l.replace(/\\[a-zA-Z]+/g, ""), l = l.replace(/[{}]/g, ""), l = l.replace(/\s+/g, " "), l = l.replace(/\\\\/g, `
`), l.trim();
}
function xt({ value: t, onChange: l }) {
  ...
  return /* @__PURE__ */ e.createElement("div", { style: { position: "relative", display: "flex", flexDirection: "column", gap: "8px" } }, /* @__PURE__ */ e.createElement("style", null, `
    ...
    "Preview Question"
  )), k && /* @__PURE__ */ e.createElement("div", { style: {
    position: "fixed",
    top: 0,
    left: 0,
    width: "100vw",
