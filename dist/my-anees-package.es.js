...
import { Essentials as Ce, Bold as Le, Italic as Se, Underline as Te, Paragraph as We, Heading as Be, Table as Ie, TableToolbar as De, TableCellProperties as Ne, TableProperties as Re, List as He, Link as Oe, Undo as Ue, ClassicEditor as Ve, Plugin as be, ButtonView as oe, Widget as Pe, toWidget as qe } from "ckeditor5";
...
function Ke({ isOpen: r, onClose: l, onInsert: c, position: a }) {
  ...
  return /* @__PURE__ */ e.createElement("div", { className: "scm-overlay", onMouseDown: (k) => {
    k.stopPropagation(), l();
  } }, /* @__PURE__ */ e.createElement("div", { className: "scm-modal", style: S, onMouseDown: (k) => k.stopPropagation() }, /* @__PURE__ */ e.createElement("div", { className: "scm-toolbar" }, /* @__PURE__ */ e.createElement(
    "input",
    {
      type: "text",
      placeholder: "Code",
...
function nt({ matrixType: r, x: l, y: c, onSelect: a, onMouseEnter: i, onMouseLeave: s }) {
  const [n, o] = B({ r: 2, c: 2 }), m = Math.max(10, parseInt(n.r, 10) || 0), M = Math.max(10, parseInt(n.c, 10) || 0), u = (g) => {
    ...
    isNaN(I) || o((T) => ({ ...T, r: Math.max(1, Math.min(10, I)) }));
  }, S = () => {
    ...
    const I = parseInt(w, 10);
    isNaN(I) || o((T) => ({ ...T, c: Math.max(1, Math.min(10, I)) }));
  }, x = () => {
  ...
  return R(() => {
    const g = (w) => {
      if (w.key === "Enter") {
        ...
        const I = parseInt(n.r, 10) || 1, T = parseInt(n.c, 10) || 1;
        a(I, T);
      }
    };
    ...
    /* @__PURE__ */ e.createElement("div", { className: "cme-matrix-hover-grid" }, Array.from({ length: m }).map((g, w) => /* @__PURE__ */ e.createElement("div", { key: w, className: "cme-matrix-hover-row" }, Array.from({ length: M }).map((I, T) => {
...
function at({ mode: r, onInsert: l, onClose: c, initialLatex: a, isEditing: i }) {
  const s = F(null), [n, o] = B(0), [m, M] = B(null), [u, S] = B(null), [k, x] = B(null), [g, w] = B(null);
  F(null);
  const [I, T] = B({ x: 0, y: 0 }), [U, A] = B(!1), L = F({ x: 0, y: 0 });
  R(() => {
    const t = (p) => {
      U && T({
  ...
  const C = (t) => {
    t.target.closest(".cme-popup-close") || (A(!0), L.current = {
      x: t.clientX - I.x,
      y: t.clientY - I.y
    });
  }, v = r === "math" ? _e : $e, [d, D] = B({
  ...
  R(() => {
    ...
    const t = s.current;
    if (!t) return;
    t.setOptions({ macros: window.__cme_macros || {} }), t.defaultMode = "math";
    const h = () => {
      ...
      return p.map((E, f) => /* @__PURE__ */ e.createElement(
        ...
        E.moreItems && /* @__PURE__ */ e.createElement(
          "button",
          {
            ...
            title: "more",
            onMouseDown: (b) => {
              if (b.preventDefault(), g && g.items === E.moreItems)
                w(null);
              else {
        ...
        E.items.map((b, V) => {
          ...
          if (b.type === "dropdown") {
            ...
            return /* @__PURE__ */ e.createElement(
              ...
              /* @__PURE__ */ e.createElement("option", { value: "" }, b.label),
          ...
          if (P.isMatrix && !b.directInsert)
            return /* @__PURE__ */ e.createElement(
              ...
              /* @__PURE__ */ e.createElement(
                ...
                typeof b.label == "object" ? b.label : /* @__PURE__ */ e.createElement(
                  "math-field",
                  {
                    "read-only": !0,
                    style: {
                  ...
                  ee(b.mathLabel != null ? b.mathLabel : b.insert)
                )
              )
            );
          ...
          return /* @__PURE__ */ e.createElement(
            "button",
            {
              ...
              onMouseDown: (O) => {
                ...
                O.preventDefault();
                const W = s.current;
                if (b.action === "SPECIAL_CHARS") {
                  const N = O.currentTarget.getBoundingClientRect();
                  S({ x: N.left, y: N.bottom + 4 });
                } else if (b.action === "TEXT_COLOR") {
                  const N = O.currentTarget.getBoundingClientRect();
                ...
                } else b.action === "UNDO" ? (z = s.current) == null || z.executeCommand("undo") : b.action === "REDO" ? (X = s.current) == null || X.executeCommand("redo") : Z(b.insert);
              }
            },
            (P.isTemplate || P.label === "√(□)" || P.isMatrix || b.isWidget) && b.insert && !b.action && !b.forceLabel ? /* @__PURE__ */ e.createElement(
              "math-field",
              {
                "read-only": !0,
                style: {
    ...
    g && K(/* @__PURE__ */ e.createElement(
      ...
      g.items.map((t, h) => /* @__PURE__ */ e.createElement(
        ...
        t.insert && !t.action && (t.cls === "template" || t.isWidget) ? /* @__PURE__ */ e.createElement(
          ...
          ee(t.mathLabel != null ? t.mathLabel : t.insert)
        ) : t.label
      ))
    ), document.body),
    /* @__PURE__ */ e.createElement(
...
function ut({ value: r, onChange: l }) {
  const c = F(null), a = F(!1), [i, s] = B(null), [n, o] = B(null);
  R(() => {
    a.current = !!i;
  }, [i]), R(() => () => {
    window.__ckMathWidgetClickHandler = null;
